...
const _TORCH_WEIGHTS: &str = "src/external_weights/layer-model.pth";
const MODEL_PATH: &str = "src/model_binaries/layer-model.mpk";
const CONFIG_PATH: &str = "src/configs/wav2vec2-base-layer.json";
